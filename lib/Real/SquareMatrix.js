...
//-----------------------------------------------------------------------------
  ...
  // ma sarebbe meglio avere una classe Collection(of elements) che lo fa su tutti gli elementi,
  // chiamando un metodo coerceToRealElement, qualcosa del tipo
  // _elements = new Collection(arg.elements);
  // _elements.coerceToRealElement();
  for (var i in _elements) {
    _elements[i] = coerce.toRealElement(_elements[i]);
  }
